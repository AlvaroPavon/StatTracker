...
== Diagramas de Requisitos con Mermaid

=== Diagrama General de Requisitos
...
. *Visual Studio Code*: Instala la extensión "Mermaid Preview"
. *IntelliJ IDEA*: Instala el plugin "Mermaid"
. *Online*: Usa https://mermaid.live para visualizar y editar
...
Estos mockups complementan el manual de usuario (`manual-usuario.adoc`) proporcionando una representación visual de los flujos descritos textualmente en el manual.
...
|1.0
|Enero 2025
|Creación inicial de los 4 mockups principales
|===
